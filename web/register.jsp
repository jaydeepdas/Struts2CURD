...
<html>
    ...
    <body style='background-color: lightgreen;'>
        ...
        <a href="report"><button style='background-color: yellow; color: red'  class="button-report" type="button">Report</button></a>
        <br><br>
        <a href="product.jsp"><button style='background-color: orangered; color: black'   class="button-report" type="button">Product</button></a>
